<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ManageEmployeeJobs.aspx.cs" Inherits="LMS.Admin.ManageEmployeeJobs" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section id="HourlyJob">
    <div class="row" style="padding-bottom: 5px">
        <div class="col-md-12" style="background-color:darkred;color:white"><span style="font-size: 18pt" runat="server" id="EmployeeDetail"></span></div>
    </div>
    ...
    <div class="row" style="background-color: #2258A2; padding-bottom: 10px; padding-left: 10px; color: white; border-radius: 5px">
       ...
       <div class="row" style="margin: 5px">
        <div class="col-md-11" style="background-color:#000000;color:white;font-size:16pt">Employee Hourly Jobs</div>
        <div class="col-md-1" style="text-align: right">
            <asp:Button ID="Button3" runat="server" CssClass="btn btn-success" Text="+" OnClick="AddButton_Click" /></div>
    </div>
    <asp:ListView ID="LV" runat="server"
        ...
        <ItemTemplate>
            <tr>
             ...
             <%--   <td>
                  ...
                  <td>
                    <asp:Label ID="Label14" runat="server" Text='<%#Eval("OverTimeRate")%>'></asp:Label>
                </td>
                  <td>
        ...
        <InsertItemTemplate>
            <tr>
                ...
                <td>
                    <asp:TextBox ID="RateTxt" class="form-control control-txt" runat="server" Text=''></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ValidationGroup="g1"
                        ...
                        ControlToValidate="RateTxt">
                    </asp:RequiredFieldValidator>
                </td>
                <td></td>
                 <td>
                    <asp:TextBox ID="RemarksTxt" class="form-control control-txt" runat="server" Text=''></asp:TextBox>
        ...
        <EditItemTemplate>
            <tr>
              ...
              <%--   <td>
                ...
                <td>
                    <asp:TextBox ID="RateTxt" class="form-control control-txt" runat="server" Text='<%#Bind("Rate")%>'></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ValidationGroup="g1"
                        ErrorMessage="Required" Style="color: red"
                        ControlToValidate="RateTxt">
                    </asp:RequiredFieldValidator>
    ...
    <section id="SalaryJob">
         <div class="row" style="margin: 5px">
        <div class="col-md-11" style="background-color:#000000;color:white;font-size:16pt">Employee Weekly Jobs</div>
        <div class="col-md-1" style="text-align: right">
            <asp:Button ID="Button2" runat="server" CssClass="btn btn-success" Text="+" OnClick="AddButton2_Click" /></div>
    </div>
