<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ManageEmployees.aspx.cs" Inherits="LMS.Admin.ManageEmployees" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row" style="padding-bottom: 5px">
        <div class="col-md-11" style="background-color:darkred;color:white"><span style="font-size: 18pt" runat="server" id="LocationDetail"></span></div>
    ...
    <asp:ListView ID="LV" runat="server"
            ...
            <tr>
                ...
                <td>
                    <%--<asp:Label ID="Name" runat="server" Text='<%#Eval("Name")%>'></asp:Label>--%>
                     <a href="ManageEmployeeJobs.aspx?Id=<%#Eval("Id")%>"><%#Eval("Name")%></a>
                </td>
                   <td>
        ...
        <InsertItemTemplate>
            <tr>
                ...
                <td>
                    <asp:TextBox ID="NameTxt" class="form-control control-txt" runat="server" Text='<%#Bind("Name")%>'></asp:TextBox>
                 ...
                 <td>
                    <asp:TextBox ID="EmailTxt" class="form-control control-txt" runat="server" Text='<%#Bind("Email")%>'></asp:TextBox>
                 ...
                 <td>
                    <asp:TextBox ID="PhoneTxt" class="form-control control-txt" runat="server" Text='<%#Bind("Phone")%>'></asp:TextBox>
