<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ManageLocations.aspx.cs" Inherits="LMS.Admin.ManageLocations" %>
    ...
    <asp:ListView ID="LV" runat="server"
        ...
        <ItemTemplate>
            <tr>
                ...
                <td>
                    <a href="ManageEmployees.aspx?Id=<%#Eval("Id")%>"><%#Eval("Name")%></a>
        ...
        <InsertItemTemplate>
            <tr>
                ...
                <td>
                    <asp:TextBox ID="NameTxt" class="form-control control-txt" runat="server" Text=""></asp:TextBox>
