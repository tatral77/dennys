...
namespace LMS.Helper
{
    public class SalaryCaculationHelper
    {
        ...
        public WeeklyPaymentResult CalculateWeeklySchedulePayment(List<EmployeeJobSchedule> schedules)
        {
            ...
            {
                List<EmployeeJobSchedule> employeeJobSchedules= EmployeeJobScheduleRepo.GetScheduleByEmployeeId(employeeJobSchedule.LocationWeekId, employeeJobSchedule.EmployeeJob.EmployeeId);
