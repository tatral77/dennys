...
namespace LMS.Models
{
    ...
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
       ...
       public virtual DbSet<Location> Locations { get; set; }
        ...
        //    // Configure Publisher relationship with LibraryAssets
        //    modelBuilder.Entity<LibraryAssets>()
        //        .HasRequired(l => l.Publisher)
        //        .WithMany(p => p.LibraryAssetsAsPublishers)
        //        .HasForeignKey(l => l.PublisherId)
        //        .WillCascadeOnDelete(false); // Prevent cascading deletes

        //    // Configure Distributor relationship with LibraryAssets
        //    modelBuilder.Entity<LibraryAssets>()
        //        .HasRequired(l => l.Distributer)
        //        .WithMany(d => d.LibraryAssetsAsDistributors)
        //        .HasForeignKey(l => l.DistributorId)
        //        .WillCascadeOnDelete(false); // Prevent cascading deletes
        //}
